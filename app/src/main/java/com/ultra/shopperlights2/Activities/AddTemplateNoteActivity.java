...
public class AddTemplateNoteActivity extends AppCompatActivity implements EditNoteTemplateCallback
	...
	private class AddBtnListener implements View.OnClickListener
		...
		public void onClick(View v)
			...
			dialog.init(O.actions.ACTION_ADD_TEMPLATE_NOTE_ACTIVITY,templateId,"Добавить продукт");
	...
	@Override
	public void initNoteFragment(long noteId,long templateId)
		{
		AddNoteDialog dialog= new AddNoteDialog();
		dialog.init(O.actions.ACTION_ADD_TEMPLATE_NOTE_ACTIVITY,"Изменить продукт",noteId,templateId);
		FragmentTransaction transaction= getSupportFragmentManager().beginTransaction();
		dialog.show(transaction,"");
		}
	private void initAdapter()
		{
		TemplatesNotesAdapter adapter= new TemplatesNotesAdapter(this,templateId,this);
