...
public class PriceDynamicsDetailsAdapter extends RecyclerView.Adapter<PriceDynamicsDetailsAdapter.Holder>
	{
	private ArrayList<PriceDynamicsUnit> elements;

	class Holder extends RecyclerView.ViewHolder
		{
		TextView manufacturer,date,percent,priceDesc,price;
	...
	public PriceDynamicsDetailsAdapter(ArrayList<PriceDynamicsUnit> _elements)
		{
		elements=_elements;
		}
	...
	public Holder onCreateViewHolder(ViewGroup parent,int viewType)
		{
		View mainView= LayoutInflater.from(parent.getContext() ).inflate(R.layout.price_dynamics_details_list_element,parent,false);
